...
int test_speed(void)
{
	...
	for(i = 0; i < TEST_LOOP; ++i) 
	{
		...
		*/
		...
		sha256_inc_init(&ctx);
		sha256_inc_finalize(seed, &ctx, tmp, POLY_BYTES);
		sha256_inc_init(&ctx);
    ...
    cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  mont_cvt runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
    ...
    cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  poly_mul_NTT runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  polyvec_mul_NTT2_wocvt runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n"); 
	...
	cycles2 = cpucycles();
    kcycles = cycles2-cycles1;
    printf("  poly_reject_z runs in ................. %8lld cycles", kcycles/TEST_LOOP);
    printf("\n");
